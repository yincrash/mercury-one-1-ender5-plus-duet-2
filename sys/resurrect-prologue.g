...
; Order matters: home and park cold, heat away from the print (a nozzle heating while parked on
; the print oozes onto it, seen 2026-09-11), then probe and purge.
...
M116 ; wait for temperatures here, away from the print
