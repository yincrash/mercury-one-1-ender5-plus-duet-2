...
M906 X2000 Y2000 Z800 ; set axis driver currents  ; XY: Fabreeko Honey Badger 42HS48-25044A, 2.5 A rated (1.6 ohm, 1.8 mH, 0.49 N.m); 2000 mA = 80 % of rated, RRF guidance 50-85 %, TMC2660 max 2.4 A. 2026-09-11: 1600 mA stalled motor B (8 mm, ten electrical cycles) on 200 mm/s travels 12 layers into a honeycomb PETG print, drivers cool, belts fine; check motor case temperature after long prints. Z: two stock Creality 42-34 in series (0.8 A rated, 34 mm), 800 mA is 100 % of rated; fine for intermittent Z moves with I30 idle, do not raise
