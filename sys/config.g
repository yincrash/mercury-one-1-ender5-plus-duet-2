...
M906 X1600 Y1600 Z800 ; set axis driver currents  ; XY: Fabreeko Honey Badger 42HS48-25044A, 2.5 A rated (1.6 ohm, 1.8 mH, 0.49 N.m); 1600 mA = 64 % of rated, RRF guidance 50-85 %, TMC2660 max 2.4 A, Zero G formula gives 2000. 2026-09-11: 1600 stalled motor B on 200 mm/s travels with over-tight belts and 5000 travel accel; after retensioning and travel accel 3000 a 16 h print at 2000 was clean (2026-09-14), so 1600 for cooler motors until faster accelerations call for more. Z: two stock Creality 42-34 in series (0.8 A rated, 34 mm), 800 mA is 100 % of rated; fine for intermittent Z moves with I30 idle, do not raise
